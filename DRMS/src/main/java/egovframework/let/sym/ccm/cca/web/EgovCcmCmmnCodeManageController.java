...
public class EgovCcmCmmnCodeManageController {
	...
	public String selectCmmnCodeList (@ModelAttribute("loginVO") LoginVO loginVO
    	...
    	return "cmm/sym/ccm/EgovCcmCmmnCodeDtList";
	}
     ...
     * @throws Exception
     */
    @RequestMapping(value="/sym/ccm/cca/EgovCcmCmmnCodeDtList.do")
	public String selectCmmnCodeDtList (@ModelAttribute("loginVO") LoginVO loginVO
			, @ModelAttribute("searchVO") CmmnCodeVO searchVO
			, ModelMap model
			) throws Exception {
		...
		final List<CmmnCodeVO> commonCodeList = cmmnCodeManageService.selectCmmnCodeList(searchVO);
		
        model.addAttribute("paginationInfo", paginationInfo);
        model.addAttribute("resultList", commonCodeList);
